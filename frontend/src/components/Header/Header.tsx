      ...
      <div className={style.header2}>
        <div className={style.logo}>
          <Link to="/">
            <img
              src={
                'https://firebasestorage.googleapis.com/v0/b/trisog-3db22.appspot.com/o/Assets%2Flogo1.svg?alt=media&token=4a737a07-53b5-4778-8f70-4046f267dadd'
              }
              alt="logo"
            />
          </Link>
        ...
        <div className={style.user}>
          ...
          {userName ? (
            ...
            <>
              ...
              <span>/</span>
              <Link to="/signup">
                <span className={style.signup}>Signup</span>
              </Link>
            </>
          )}
        </div>
